...
Course.create!(name:'Learn to Code with Ruby', description:'A comprehensive introduction to coding with the Ruby programming language. Complete beginners welcome!', language:ruby, image_url: 'https://dc722jrlp2zu8.cloudfront.net/media/cache/74/fe/74fe79e3dd9dc4a82eeb9083b9e48813.webp')
Course.create!(name:'Ruby Metaprogramming - Complete Course', description:'Learn metaprogramming! Start writing elegant Ruby & Rails code and understanding all the magic behind Ruby on Rails.', language:ruby, image_url: 'https://blog.desafiolatam.com/wp-content/uploads/2019/01/funciones-ruby.png')
...
Course.create!(name:'HTML5 Mastery—Build Superior Websites & Mobile Apps NEW 2021', description:'Easily build 25 websites and apps (including Virtual Reality, iPhone and Android apps) with HTML5, CSS, & JavaScript', language:html, image_url:'https://acumbamail.com/blog/wp-content/uploads/2014/10/maquetacion-email-html.png')

Course.create!(name:'CSS - The Complete Guide 2021 (incl. Flexbox, Grid & Sass)', description:'Learn CSS for the first time or brush up your CSS skills and dive in even deeper. EVERY web developer has to know CSS', language:css, image_url: 'https://www.tutorialmonsters.com/wp-content/uploads/2012/05/css.jpg')
Course.create!(name:'Ultimate CSS Grid Course: From Beginner to Advanced', description:'Create CSS Grid layouts using the new grid system & use it together with CSS3 Flexbox and Sass for an amazing workflow', language:css, image_url: 'https://wwwhatsnew.com/wp-content/uploads/2021/01/aprender-css.jpg')

Course.create!(name:'The Complete JavaScript Course 2021: From Zero to Expert!', description:'The modern JavaScript course for everyone! Master JavaScript with projects, challenges and theory. Many courses in one!', language:js, image_url: 'https://img.unocero.com/2019/03/javascript.jpg')
Course.create!(name:'JavaScript - The Complete Guide 2021 (Beginner + Advanced)', description:'Modern JavaScript from the beginning - all the way up to JS expert level! THE must-have JavaScript resource in 2021.', language:js, image_url: 'https://res.cloudinary.com/practicaldev/image/fetch/s--d6Pe6bTo--/c_imagga_scale,f_auto,fl_progressive,h_1080,q_auto,w_1080/https://www.wallpapertip.com/wmimgs/83-838195_javascript-javascript-hd.png')
